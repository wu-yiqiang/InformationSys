...
var createCanvas = /* @__PURE__ */ __name(function() {
...
__name(bindPolyfill, "bindPolyfill");
...
__name(isStringSafe, "isStringSafe");
...
__name(isGradientObject, "isGradientObject");
function isImagePatternObject(value) {
  return value.image != null;
}
__name(isImagePatternObject, "isImagePatternObject");
...
__name(retrieve2, "retrieve2");
function retrieve3(value0, value1, value2) {
  return value0 != null ? value0 : value1 != null ? value1 : value2;
}
__name(retrieve3, "retrieve3");
function slice(arr) {
  var args = [];
  for (var _i = 1; _i < arguments.length; _i++) {
    args[_i - 1] = arguments[_i];
...
__name(normalizeCssArray, "normalizeCssArray");
...
__name(setAsPrimitive, "setAsPrimitive");
...
__name(createHashMap, "createHashMap");
...
function createObject(proto2, properties) {
  ...
  if (Object.create) {
    ...
    var StyleCtor = /* @__PURE__ */ __name(function() {
    }, "StyleCtor");
...
__name(distanceSquare, "distanceSquare");
...
__name(transformCoordWithViewport, "transformCoordWithViewport");
...
__name(prepareCoordMarkers, "prepareCoordMarkers");
...
__name(preparePointerTransformer, "preparePointerTransformer");
function isCanvasEl(el) {
  return el.nodeName.toUpperCase() === "CANVAS";
}
__name(isCanvasEl, "isCanvasEl");
...
__name(clientToLocal, "clientToLocal");
...
__name(calculateZrXY, "calculateZrXY");
function getNativeEvent(e2) {
  return e2 || window.event;
}
__name(getNativeEvent, "getNativeEvent");
...
__name(getWheelDeltaMayPolyfill, "getWheelDeltaMayPolyfill");
...
__name(makeEventPacket, "makeEventPacket");
function stopEvent() {
  stop(this.event);
}
...
var HoveredResult = function() {
  ...
  __name(HoveredResult2, "HoveredResult");
...
__name(isHover, "isHover");
function isOutsideBoundary(handlerInstance, x, y) {
  var painter = handlerInstance.painter;
  return x < 0 || x > painter.getWidth() || y < 0 || y > painter.getHeight();
}
__name(isOutsideBoundary, "isOutsideBoundary");
...
function TimSort(array, compare2) {
  ...
  __name(forceMergeRuns, "forceMergeRuns");
  function mergeAt(i) {
...
__name(logInvalidZError, "logInvalidZError");
...
__name(shapeCompareFunc, "shapeCompareFunc");
...
__name(clampCssByte, "clampCssByte");
function clampCssAngle(i) {
  i = Math.round(i);
  return i < 0 ? 0 : i > 360 ? 360 : i;
}
__name(clampCssAngle, "clampCssAngle");
function clampCssFloat(f) {
  return f < 0 ? 0 : f > 1 ? 1 : f;
}
__name(clampCssFloat, "clampCssFloat");
...
__name(parseCssInt, "parseCssInt");
...
__name(parseCssFloat, "parseCssFloat");
...
__name(cssHueToRgb, "cssHueToRgb");
function lerpNumber(a, b, p) {
  return a + (b - a) * p;
}
__name(lerpNumber, "lerpNumber");
...
__name(modifyAlpha, "modifyAlpha");
...
__name(interpolate1DArray, "interpolate1DArray");
...
__name(interpolate2DArray, "interpolate2DArray");
...
__name(is1DArraySame, "is1DArraySame");
function catmullRomInterpolate(p0, p1, p2, p3, t, t2, t3) {
  var v0 = (p2 - p0) * 0.5;
  var v1 = (p3 - p1) * 0.5;
  return (2 * (p1 - p2) + v0 + v1) * t3 + (-3 * (p1 - p2) - 2 * v0 - v1) * t2 + v0 * t + p1;
}
__name(catmullRomInterpolate, "catmullRomInterpolate");
...
__name(catmullRomInterpolate1DArray, "catmullRomInterpolate1DArray");
...
__name(catmullRomInterpolate2DArray, "catmullRomInterpolate2DArray");
...
__name(rgba2String, "rgba2String");
function guessArrayDim(value) {
  return isArrayLike(value && value[0]) ? 2 : 1;
}
__name(guessArrayDim, "guessArrayDim");
var tmpRgba = [0, 0, 0, 0];
var Track = function() {
...
__name(isPointerFromTouch, "isPointerFromTouch");
...
__name(setTouchTimer, "setTouchTimer");
function markTouch(event) {
  event && (event.zrByTouch = true);
}
__name(markTouch, "markTouch");
function normalizeGlobalEvent(instance, event) {
  return normalizeEvent(instance.dom, new FakeGlobalEvent(instance, event), true);
}
__name(normalizeGlobalEvent, "normalizeGlobalEvent");
...
var FakeGlobalEvent = function() {
  ...
  __name(FakeGlobalEvent2, "FakeGlobalEvent");
...
__name(mountLocalDOMEventListeners, "mountLocalDOMEventListeners");
function mountGlobalDOMEventListeners(instance, scope) {
  ...
  function mount(nativeEventName) {
    ...
    __name(nativeEventListener, "nativeEventListener");
    mountSingleDOMEventListener(scope, nativeEventName, nativeEventListener, {capture: true});
  }
  __name(mount, "mount");
}
__name(mountGlobalDOMEventListeners, "mountGlobalDOMEventListeners");
function mountSingleDOMEventListener(scope, nativeEventName, listener, opt) {
  scope.mounted[nativeEventName] = listener;
  scope.listenerOpts[nativeEventName] = opt;
  addEventListener(scope.domTarget, nativeEventName, listener, opt);
}
__name(mountSingleDOMEventListener, "mountSingleDOMEventListener");
...
__name(unmountDOMEventListeners, "unmountDOMEventListeners");
var DOMHandlerScope = function() {
  ...
  __name(DOMHandlerScope2, "DOMHandlerScope");
...
var HandlerDomProxy = function(_super) {
  ...
  __name(HandlerDomProxy2, "HandlerDomProxy");
...
__name(isNotAroundZero, "isNotAroundZero");
var scaleTmp = [];
var tmpTransform = [];
...
var Transformable = function() {
  ...
  __name(Transformable2, "Transformable");
...
var BoundingRect = function() {
  ...
  __name(BoundingRect2, "BoundingRect");
...
__name(defaultMeasureText, "defaultMeasureText");
var methods2 = {
...
__name(innerGetBoundingRect, "innerGetBoundingRect");
...
__name(adjustTextX, "adjustTextX");
...
__name(adjustTextY, "adjustTextY");
...
__name(parsePercent, "parsePercent");
...
__name(calculateTextPosition, "calculateTextPosition");
...
var Element = function() {
  ...
  Element2.initDefaultProps = function() {
    ...
    function createLegacyProperty(key, privateKey, xKey, yKey) {
      ...
      __name(enhanceArray, "enhanceArray");
    }
    __name(createLegacyProperty, "createLegacyProperty");
...
function animateTo(animatable, target, cfg, animationProps, reverse) {
  ...
  var doneCb = /* @__PURE__ */ __name(function() {
    doneHappened = true;
    finishCount--;
    if (finishCount <= 0) {
  ...
  var abortedCb = /* @__PURE__ */ __name(function() {
    finishCount--;
    if (finishCount <= 0) {
      doneHappened ? cfgDone && cfgDone() : cfgAborted && cfgAborted();
    }
...
__name(animateTo, "animateTo");
function copyArrShallow(source, target, len2) {
  for (var i = 0; i < len2; i++) {
    source[i] = target[i];
  }
}
__name(copyArrShallow, "copyArrShallow");
function is2DArray(value) {
  return isArrayLike(value[0]);
}
__name(is2DArray, "is2DArray");
...
__name(animateToShallow, "animateToShallow");
...
__name(delInstance, "delInstance");
...
__name(registerPainter, "registerPainter");
var version = "5.1.1";
...
__name(parsePercent2, "parsePercent");
...
__name(getPixelPrecision, "getPixelPrecision");
...
__name(getPercentWithPrecision, "getPercentWithPrecision");
function addSafe(val0, val1) {
  var maxPrecision = Math.max(getPrecision(val0), getPrecision(val1));
  var sum = val0 + val1;
  return maxPrecision > ROUND_SUPPORTED_PRECISION_MAX ? sum : round(sum, maxPrecision);
}
__name(addSafe, "addSafe");
var MAX_SAFE_INTEGER = 9007199254740991;
function remRadian(radian) {
  var pi2 = Math.PI * 2;
  return (radian % pi2 + pi2) % pi2;
}
__name(remRadian, "remRadian");
function isRadianAroundZero(val) {
  return val > -RADIAN_EPSILON && val < RADIAN_EPSILON;
}
__name(isRadianAroundZero, "isRadianAroundZero");
...
__name(quantityExponent, "quantityExponent");
...
function reformIntervals(list) {
  ...
  __name(littleThan, "littleThan");
}
__name(reformIntervals, "reformIntervals");
function numericToNumber(val) {
  var valFloat = parseFloat(val);
  return valFloat == val && (valFloat !== 0 || typeof val !== "string" || val.indexOf("x") <= 0) ? valFloat : NaN;
}
__name(numericToNumber, "numericToNumber");
...
__name(getRandomIdBase, "getRandomIdBase");
...
__name(getGreatestCommonDividor, "getGreatestCommonDividor");
...
__name(defaultEmphasis, "defaultEmphasis");
var TEXT_STYLE_OPTIONS = ["fontStyle", "fontWeight", "fontSize", "fontFamily", "rich", "tag", "color", "textBorderColor", "textBorderWidth", "width", "height", "lineHeight", "align", "verticalAlign", "baseline", "shadowColor", "shadowBlur", "shadowOffsetX", "shadowOffsetY", "textShadowColor", "textShadowBlur", "textShadowOffsetX", "textShadowOffsetY", "backgroundColor", "borderColor", "borderWidth", "borderRadius", "padding"];
function getDataItemValue(dataItem) {
  return isObject(dataItem) && !isArray(dataItem) && !(dataItem instanceof Date) ? dataItem.value : dataItem;
}
__name(getDataItemValue, "getDataItemValue");
function isDataItemOption(dataItem) {
  return isObject(dataItem) && !(dataItem instanceof Array);
}
__name(isDataItemOption, "isDataItemOption");
...
__name(mappingToExists, "mappingToExists");
...
__name(prepareResult, "prepareResult");
...
__name(mappingById, "mappingById");
...
__name(mappingByName, "mappingByName");
...
__name(mappingByIndex, "mappingByIndex");
...
__name(mappingInReplaceAllMode, "mappingInReplaceAllMode");
...
__name(makeIdAndName, "makeIdAndName");
...
__name(isNameSpecified, "isNameSpecified");
function isComponentIdInternal(cmptOption) {
  return cmptOption && cmptOption.id != null && makeComparableKey(cmptOption.id).indexOf(INTERNAL_COMPONENT_ID_PREFIX) === 0;
}
__name(isComponentIdInternal, "isComponentIdInternal");
...
__name(determineSubType, "determineSubType");
...
__name(queryDataIndex, "queryDataIndex");
function makeInner() {
...
__name(parseFinder, "parseFinder");
...
__name(preParseFinder, "preParseFinder");
...
__name(queryReferringComponents, "queryReferringComponents");
...
__name(interpolateRawValues, "interpolateRawValues");
...
__name(parseClassType, "parseClassType");
function checkClassType(componentType) {
  assert(/^[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)?$/.test(componentType), 'componentType "' + componentType + '" illegal');
}
__name(checkClassType, "checkClassType");
...
function enableClassExtend(rootClz, mandatoryMethods) {
  ...
  rootClz.extend = function(proto2) {
    ...
    __name(ExtendedClass, "ExtendedClass");
...
__name(enableClassExtend, "enableClassExtend");
function isESClass(fn) {
  return typeof fn === "function" && /^class\s/.test(Function.prototype.toString.call(fn));
}
__name(isESClass, "isESClass");
function mountExtend(SubClz, SupperClz) {
  SubClz.extend = SupperClz.extend;
}
__name(mountExtend, "mountExtend");
...
__name(enableClassCheck, "enableClassCheck");
...
__name(superCall, "superCall");
function superApply(context, methodName, args) {
  return this.superClass.prototype[methodName].apply(context, args);
}
__name(superApply, "superApply");
function enableClassManagement(target) {
  ...
  __name(makeContainer, "makeContainer");
}
__name(enableClassManagement, "enableClassManagement");
...
__name(makeStyleMapper, "makeStyleMapper");
...
var AreaStyleMixin = function() {
  ...
  __name(AreaStyleMixin2, "AreaStyleMixin");
...
__name(findExistImage, "findExistImage");
...
__name(createOrUpdateImage, "createOrUpdateImage");
...
__name(imageOnLoad, "imageOnLoad");
function isImageReady(image) {
  return image && image.width && image.height;
}
__name(isImageReady, "isImageReady");
...
__name(prepareTruncateOptions, "prepareTruncateOptions");
...
__name(truncateSingleLine, "truncateSingleLine");
...
__name(estimateLength, "estimateLength");
...
__name(parsePlainText, "parsePlainText");
var RichTextToken = function() {
  function RichTextToken2() {
  }
  __name(RichTextToken2, "RichTextToken");
...
var RichTextLine = function() {
  ...
  __name(RichTextLine2, "RichTextLine");
...
var RichTextContentBlock = function() {
  ...
  __name(RichTextContentBlock2, "RichTextContentBlock");
...
__name(parseRichText, "parseRichText");
...
__name(pushTokens, "pushTokens");
function isLatin(ch) {
  var code = ch.charCodeAt(0);
  return code >= 33 && code <= 255;
}
__name(isLatin, "isLatin");
...
__name(isWordBreakChar, "isWordBreakChar");
...
var Displayable = function(_super) {
  ...
  __name(Displayable2, "Displayable");
...
__name(isDisplayableCulled, "isDisplayableCulled");
...
__name(isAroundZero, "isAroundZero");
function isNotAroundZero2(val) {
  return val > EPSILON2 || val < -EPSILON2;
}
__name(isNotAroundZero2, "isNotAroundZero");
function cubicAt(p0, p1, p2, p3, t) {
  var onet = 1 - t;
  return onet * onet * (onet * p0 + 3 * t * p1) + t * t * (t * p3 + 3 * onet * p2);
}
__name(cubicAt, "cubicAt");
function cubicDerivativeAt(p0, p1, p2, p3, t) {
  var onet = 1 - t;
  return 3 * (((p1 - p0) * onet + 2 * (p2 - p1) * t) * onet + (p3 - p2) * t * t);
}
__name(cubicDerivativeAt, "cubicDerivativeAt");
...
__name(cubicRootAt, "cubicRootAt");
...
__name(cubicExtrema, "cubicExtrema");
...
__name(cubicSubdivide, "cubicSubdivide");
...
__name(cubicProjectPoint, "cubicProjectPoint");
...
__name(cubicLength, "cubicLength");
function quadraticAt(p0, p1, p2, t) {
  var onet = 1 - t;
  return onet * (onet * p0 + 2 * t * p1) + t * t * p2;
}
__name(quadraticAt, "quadraticAt");
function quadraticDerivativeAt(p0, p1, p2, t) {
  return 2 * ((1 - t) * (p1 - p0) + t * (p2 - p1));
}
__name(quadraticDerivativeAt, "quadraticDerivativeAt");
...
__name(quadraticRootAt, "quadraticRootAt");
...
__name(quadraticExtremum, "quadraticExtremum");
...
__name(quadraticSubdivide, "quadraticSubdivide");
...
__name(quadraticProjectPoint, "quadraticProjectPoint");
...
__name(quadraticLength, "quadraticLength");
...
__name(fromQuadratic, "fromQuadratic");
...
__name(normalizeArcAngles, "normalizeArcAngles");
...
__name(containStroke, "containStroke");
...
__name(containStroke2, "containStroke");
...
__name(containStroke3, "containStroke");
...
__name(normalizeRadian, "normalizeRadian");
...
__name(containStroke4, "containStroke");
...
__name(windingLine, "windingLine");
...
__name(isAroundEqual, "isAroundEqual");
var roots = [-1, -1, -1];
var extrema = [-1, -1];
...
__name(swapExtrema, "swapExtrema");
...
__name(windingCubic, "windingCubic");
...
__name(windingQuadratic, "windingQuadratic");
...
__name(containPath, "containPath");
...
__name(containStroke5, "containStroke");
...
__name(isImageLike, "isImageLike");
var ZRImage = function(_super) {
  __extends2(ZRImage2, _super);
  function ZRImage2() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  __name(ZRImage2, "ZRImage");
...
__name(subPixelOptimizeLine, "subPixelOptimizeLine");
...
__name(subPixelOptimizeRect, "subPixelOptimizeRect");
...
__name(subPixelOptimize, "subPixelOptimize");
...
__name(normalizeTextStyle, "normalizeTextStyle");
...
__name(getTextXForPadding, "getTextXForPadding");
function getStyleText(style) {
  var text = style.text;
  text != null && (text += "");
  return text;
}
__name(getStyleText, "getStyleText");
...
__name(hasFillOrStroke, "hasFillOrStroke");
...
__name(doChangeHoverState, "doChangeHoverState");
function singleEnterEmphasis(el) {
  doChangeHoverState(el, "emphasis", HOVER_STATE_EMPHASIS);
}
__name(singleEnterEmphasis, "singleEnterEmphasis");
function singleLeaveEmphasis(el) {
  if (el.hoverState === HOVER_STATE_EMPHASIS) {
    doChangeHoverState(el, "normal", HOVER_STATE_NORMAL);
  }
}
__name(singleLeaveEmphasis, "singleLeaveEmphasis");
function singleEnterBlur(el) {
  doChangeHoverState(el, "blur", HOVER_STATE_BLUR);
}
__name(singleEnterBlur, "singleEnterBlur");
function singleLeaveBlur(el) {
  if (el.hoverState === HOVER_STATE_BLUR) {
    doChangeHoverState(el, "normal", HOVER_STATE_NORMAL);
  }
}
__name(singleLeaveBlur, "singleLeaveBlur");
function singleEnterSelect(el) {
  el.selected = true;
}
__name(singleEnterSelect, "singleEnterSelect");
function singleLeaveSelect(el) {
  el.selected = false;
}
__name(singleLeaveSelect, "singleLeaveSelect");
function updateElementState(el, updater, commonParam) {
  updater(el, commonParam);
}
__name(updateElementState, "updateElementState");
...
__name(traverseUpdateState, "traverseUpdateState");
...
__name(getFromStateStyle, "getFromStateStyle");
...
__name(createEmphasisDefaultState, "createEmphasisDefaultState");
...
__name(createSelectDefaultState, "createSelectDefaultState");
...
__name(createBlurDefaultState, "createBlurDefaultState");
...
__name(elementStateProxy, "elementStateProxy");
...
__name(allLeaveBlur, "allLeaveBlur");
function blurSeries(targetSeriesIndex, focus, blurScope, api) {
  ...
  __name(leaveBlurOfIndices, "leaveBlurOfIndices");
...
__name(blurComponent, "blurComponent");
...
__name(blurSeriesFromHighlightPayload, "blurSeriesFromHighlightPayload");
...
__name(handleGlboalMouseOutForHighDown, "handleGlboalMouseOutForHighDown");
...
__name(toggleSelectionFromPayload, "toggleSelectionFromPayload");
...
__name(updateSeriesElementSelection, "updateSeriesElementSelection");
...
__name(getAllSelectedIndices, "getAllSelectedIndices");
function enableHoverEmphasis(el, focus, blurScope) {
  setAsHighDownDispatcher(el, true);
  traverseUpdateState(el, setDefaultStateProxy);
  enableHoverFocus(el, focus, blurScope);
}
__name(enableHoverEmphasis, "enableHoverEmphasis");
...
__name(enableHoverFocus, "enableHoverFocus");
...
__name(setAsHighDownDispatcher, "setAsHighDownDispatcher");
function isHighDownDispatcher(el) {
  return !!(el && el.__highDownDispatcher);
}
__name(isHighDownDispatcher, "isHighDownDispatcher");
...
__name(getHighlightDigit, "getHighlightDigit");
function isSelectChangePayload(payload) {
  var payloadType = payload.type;
  return payloadType === SELECT_ACTION_TYPE || payloadType === UNSELECT_ACTION_TYPE || payloadType === TOGGLE_SELECT_ACTION_TYPE;
}
__name(isSelectChangePayload, "isSelectChangePayload");
...
__name(savePathStates, "savePathStates");
...
__name(vRatio, "vRatio");
function vAngle(u, v) {
  return (u[0] * v[1] < u[1] * v[0] ? -1 : 1) * Math.acos(vRatio(u, v));
}
__name(vAngle, "vAngle");
...
__name(createPathProxyFromString, "createPathProxyFromString");
var SVGPath = function(_super) {
  __extends2(SVGPath2, _super);
  function SVGPath2() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  __name(SVGPath2, "SVGPath");
...
__name(isPathProxy, "isPathProxy");
...
__name(createPathOptions, "createPathOptions");
function createFromString(str, opts) {
  return new SVGPath(createPathOptions(str, opts));
}
__name(createFromString, "createFromString");
...
__name(extendFromString, "extendFromString");
...
var EllipseShape = function() {
  ...
  __name(EllipseShape2, "EllipseShape");
...
__name(computeCornerTangents, "computeCornerTangents");
...
var SectorShape = function() {
  ...
  __name(SectorShape2, "SectorShape");
  return SectorShape2;
}();
...
__name(smoothSpline, "smoothSpline");
...
__name(smoothBezier, "smoothBezier");
...
var PolylineShape = function() {
  ...
  __name(PolylineShape2, "PolylineShape");
...
var BezierCurveShape = function() {
  ...
  __name(BezierCurveShape2, "BezierCurveShape");
...
__name(someVectorAt, "someVectorAt");
...
var CompoundPath = function(_super) {
  ...
  __name(CompoundPath2, "CompoundPath");
...
var RadialGradient = function(_super) {
  ...
  __name(RadialGradient2, "RadialGradient");
...
var OrientedBoundingRect = function() {
  ...
  __name(OrientedBoundingRect2, "OrientedBoundingRect");
...
var IncrementalDisplayable = function(_super) {
  ...
  __name(IncrementalDisplayable2, "IncrementalDisplayable");
...
__name(extendShape, "extendShape");
...
__name(registerShape, "registerShape");
function getShapeClass(name) {
  if (_customShapeMap.hasOwnProperty(name)) {
    return _customShapeMap[name];
  }
}
__name(getShapeClass, "getShapeClass");
...
__name(centerGraphic, "centerGraphic");
...
__name(animateOrSetProps, "animateOrSetProps");
...
__name(isElementRemoved, "isElementRemoved");
...
__name(clipPointsByRect, "clipPointsByRect");
...
__name(clipRectByRect, "clipRectByRect");
...
__name(setLabelText, "setLabelText");
...
__name(getLabelText, "getLabelText");
...
__name(setTextStyleCommon, "setTextStyleCommon");
...
__name(getRichItemNames, "getRichItemNames");
...
__name(setTokenTextStyle, "setTokenTextStyle");
...
var TextStyleMixin = function() {
  ...
  __name(TextStyleMixin2, "TextStyleMixin");
...
var LineStyleMixin = function() {
  ...
  __name(LineStyleMixin2, "LineStyleMixin");
...
var ItemStyleMixin = function() {
  ...
  __name(ItemStyleMixin2, "ItemStyleMixin");
...
__name(enableSubTypeDefaulter, "enableSubTypeDefaulter");
function enableTopologicalTravel(entity, dependencyGetter) {
  entity.topologicalTravel = function(targetNameList, fullNameList, callback, context) {
    ...
    __name(removeEdge, "removeEdge");
    function removeEdgeAndAdd(succComponentType) {
      targetNameSet[succComponentType] = true;
      removeEdge(succComponentType);
    }
    __name(removeEdgeAndAdd, "removeEdgeAndAdd");
  };
  ...
  __name(makeDepndencyGraph, "makeDepndencyGraph");
  ...
  __name(createDependencyGraphItem, "createDependencyGraphItem");
  ...
  __name(getAvailableDependencies, "getAvailableDependencies");
}
__name(enableTopologicalTravel, "enableTopologicalTravel");
...
__name(registerLocale, "registerLocale");
...
__name(createLocaleObject, "createLocaleObject");
function getLocaleModel(lang) {
  return localeModels[lang];
}
__name(getLocaleModel, "getLocaleModel");
function getDefaultLocaleModel() {
  return localeModels[DEFAULT_LOCALE];
}
__name(getDefaultLocaleModel, "getDefaultLocaleModel");
...
__name(getPrimaryTimeUnit, "getPrimaryTimeUnit");
function isPrimaryTimeUnit(timeUnit) {
  return timeUnit === getPrimaryTimeUnit(timeUnit);
}
__name(isPrimaryTimeUnit, "isPrimaryTimeUnit");
...
__name(getDefaultFormatPrecisionOfInterval, "getDefaultFormatPrecisionOfInterval");
...
__name(leveledFormat, "leveledFormat");
...
__name(getUnitFromValue, "getUnitFromValue");
...
__name(fullYearGetterName, "fullYearGetterName");
function monthGetterName(isUTC) {
  return isUTC ? "getUTCMonth" : "getMonth";
}
__name(monthGetterName, "monthGetterName");
function dateGetterName(isUTC) {
  return isUTC ? "getUTCDate" : "getDate";
}
__name(dateGetterName, "dateGetterName");
function hoursGetterName(isUTC) {
  return isUTC ? "getUTCHours" : "getHours";
}
__name(hoursGetterName, "hoursGetterName");
function minutesGetterName(isUTC) {
  return isUTC ? "getUTCMinutes" : "getMinutes";
}
__name(minutesGetterName, "minutesGetterName");
function secondsGetterName(isUTC) {
  return isUTC ? "getUTCSeconds" : "getSeconds";
}
__name(secondsGetterName, "secondsGetterName");
function millisecondsGetterName(isUTC) {
  return isUTC ? "getUTCSeconds" : "getSeconds";
}
__name(millisecondsGetterName, "millisecondsGetterName");
function fullYearSetterName(isUTC) {
  return isUTC ? "setUTCFullYear" : "setFullYear";
}
__name(fullYearSetterName, "fullYearSetterName");
function monthSetterName(isUTC) {
  return isUTC ? "setUTCMonth" : "setMonth";
}
__name(monthSetterName, "monthSetterName");
function dateSetterName(isUTC) {
  return isUTC ? "setUTCDate" : "setDate";
}
__name(dateSetterName, "dateSetterName");
function hoursSetterName(isUTC) {
  return isUTC ? "setUTCHours" : "setHours";
}
__name(hoursSetterName, "hoursSetterName");
function minutesSetterName(isUTC) {
  return isUTC ? "setUTCMinutes" : "setMinutes";
}
__name(minutesSetterName, "minutesSetterName");
function secondsSetterName(isUTC) {
  return isUTC ? "setUTCSeconds" : "setSeconds";
}
__name(secondsSetterName, "secondsSetterName");
function millisecondsSetterName(isUTC) {
  return isUTC ? "setUTCSeconds" : "setSeconds";
}
__name(millisecondsSetterName, "millisecondsSetterName");
...
var wrapVar = /* @__PURE__ */ __name(function(varName, seriesIdx) {
...
__name(getTooltipMarker, "getTooltipMarker");
...
__name(capitalFirst, "capitalFirst");
...
__name(convertToColorString, "convertToColorString");
...
__name(fetchLayoutMode, "fetchLayoutMode");
...
__name(mergeLayoutParam, "mergeLayoutParam");
function getLayoutParams(source) {
  return copyLayoutParams({}, source);
}
__name(getLayoutParams, "getLayoutParams");
...
__name(copyLayoutParams, "copyLayoutParams");
...
var ComponentModel = function(_super) {
  ...
  __name(ComponentModel2, "ComponentModel");
...
__name(resetSourceDefaulter, "resetSourceDefaulter");
function makeSeriesEncodeForAxisCoordSys(coordDimensions, seriesModel, source) {
  ...
  __name(pushDim, "pushDim");
  function getDataDimCountOnCoordDim(coordDimInfo) {
    var dimsDef = coordDimInfo.dimsDef;
    return dimsDef ? dimsDef.length : 1;
  }
  __name(getDataDimCountOnCoordDim, "getDataDimCountOnCoordDim");
...
__name(querySeriesUpstreamDatasetModel, "querySeriesUpstreamDatasetModel");
...
__name(queryDatasetUpstreamDatasetModels, "queryDatasetUpstreamDatasetModels");
function guessOrdinal(source, dimIndex) {
  return doGuessOrdinal(source.data, source.sourceFormat, source.seriesLayoutBy, source.dimensionsDefine, source.startIndex, dimIndex);
}
__name(guessOrdinal, "guessOrdinal");
function doGuessOrdinal(data, sourceFormat, seriesLayoutBy, dimensionsDefine, startIndex, dimIndex) {
  ...
  __name(detectValue, "detectValue");
  return BE_ORDINAL.Not;
}
__name(doGuessOrdinal, "doGuessOrdinal");
...
var PaletteMixin = function() {
  ...
  __name(PaletteMixin2, "PaletteMixin");
...
__name(getNearestPalette, "getNearestPalette");
...
var GlobalModel = function(_super) {
  ...
  GlobalModel2.prototype.findComponents = function(condition) {
    ...
    __name(getQueryCond, "getQueryCond");
    function doFilter(res) {
      return condition.filter ? filter(res, condition.filter) : res;
    }
    __name(doFilter, "doFilter");
  };
  ...
  GlobalModel2.internalField = function() {
    reCreateSeriesIndices = /* @__PURE__ */ __name(function(ecModel) {
...
__name(isNotTargetSeries, "isNotTargetSeries");
...
__name(queryByIdOrName, "queryByIdOrName");
function filterBySubType(components, condition) {
  return condition.hasOwnProperty("subType") ? filter(components, function(cmpt) {
    return cmpt && cmpt.subType === condition.subType;
  }) : components;
}
__name(filterBySubType, "filterBySubType");
...
__name(normalizeSetOptionInput, "normalizeSetOptionInput");
...
var ExtensionAPI = function() {
  ...
  __name(ExtensionAPI2, "ExtensionAPI");
...
var CoordinateSystemManager = function() {
  ...
  __name(CoordinateSystemManager2, "CoordinateSystemManager");
...
function parseRawOption(rawOption, optionPreprocessorFuncs2, isNew) {
  ...
  __name(doPreprocess, "doPreprocess");
  return {
    baseOption,
...
__name(parseRawOption, "parseRawOption");
...
__name(applyMediaQuery, "applyMediaQuery");
...
__name(indicesEquals, "indicesEquals");
...
__name(compatEC2ItemStyle, "compatEC2ItemStyle");
...
__name(convertNormalEmphasis, "convertNormalEmphasis");
...
__name(removeEC3NormalStatus, "removeEC3NormalStatus");
...
__name(compatTextStyle, "compatTextStyle");
...
__name(compatEC3CommonStyles, "compatEC3CommonStyles");
...
__name(processSeries, "processSeries");
function toArr(o) {
...
__name(globalCompatStyle, "globalCompatStyle");
...
__name(compatLayoutProperties, "compatLayoutProperties");
...
__name(compatBarItemStyle, "compatBarItemStyle");
...
__name(compatPieLabel, "compatPieLabel");
...
__name(compatGraphFocus, "compatGraphFocus");
...
__name(globalBackwardCompat, "globalBackwardCompat");
...
__name(calculateStack, "calculateStack");
...
__name(isSourceInstance, "isSourceInstance");
...
__name(createSource, "createSource");
...
__name(createSourceFromSeriesDataOption, "createSourceFromSeriesDataOption");
...
__name(detectSourceFormat, "detectSourceFormat");
...
__name(determineSourceDimensions, "determineSourceDimensions");
...
__name(objectRowsCollectDimensions, "objectRowsCollectDimensions");
...
__name(normalizeDimensionsOption, "normalizeDimensionsOption");
...
__name(arrayRowsTravelFirst, "arrayRowsTravelFirst");
...
var DefaultDataProvider = function() {
  ...
  DefaultDataProvider2.internalField = function() {
    var _a2;
    mountMethods = /* @__PURE__ */ __name(function(provider, data, source) {
    ...
    var getItemForTypedArray = /* @__PURE__ */ __name(function(idx, out2) {
    ...
    var fillStorageForTypedArray = /* @__PURE__ */ __name(function(start2, end2, storage2, extent3) {
      var data = this._data;
      var dimSize = this._dimSize;
    ...
    var countForTypedArray = /* @__PURE__ */ __name(function() {
    ...
    __name(appendDataSimply, "appendDataSimply");
  }();
  return DefaultDataProvider2;
}();
var getItemSimply = /* @__PURE__ */ __name(function(rawData, startIndex, dimsDef, idx) {
  return rawData[idx];
}, "getItemSimply");
...
var countSimply = /* @__PURE__ */ __name(function(rawData, startIndex, dimsDef) {
...
var getRawValueSimply = /* @__PURE__ */ __name(function(dataItem, dimIndex, dimName) {
...
__name(getMethodMapKey, "getMethodMapKey");
...
__name(retrieveRawValue, "retrieveRawValue");
...
var Task = function() {
  ...
  Task2.prototype.perform = function(performArgs) {
    ...
    __name(normalizeModBy, "normalizeModBy");
...
var iterator = function() {
  ...
  __name(sequentialNext, "sequentialNext");
  function modNext() {
...
__name(createExternalSource, "createExternalSource");
...
__name(cloneRawData, "cloneRawData");
...
__name(getDimensionInfo, "getDimensionInfo");
function cloneAllDimensionInfo(dimensions) {
  return clone(dimensions);
}
__name(cloneAllDimensionInfo, "cloneAllDimensionInfo");
...
__name(registerExternalTransform, "registerExternalTransform");
...
__name(applyDataTransform, "applyDataTransform");
...
__name(applySingleDataTransform, "applySingleDataTransform");
function isSupportedSourceFormat(sourceFormat) {
  return sourceFormat === SOURCE_FORMAT_ARRAY_ROWS || sourceFormat === SOURCE_FORMAT_OBJECT_ROWS;
}
__name(isSupportedSourceFormat, "isSupportedSourceFormat");
...
__name(disableTransformOptionMerge, "disableTransformOptionMerge");
...
__name(createTooltipMarkup, "createTooltipMarkup");
function retrieveVisualColorForTooltipMarker(series, dataIndex) {
  var style = series.getData().getItemVisual(dataIndex, "style");
  var color2 = style[series.visualDrawType];
  return convertToColorString(color2);
}
__name(retrieveVisualColorForTooltipMarker, "retrieveVisualColorForTooltipMarker");
...
__name(defaultSeriesFormatTooltip, "defaultSeriesFormatTooltip");
function formatTooltipArrayValue(value, series, dataIndex, tooltipDims, colorStr) {
  ...
  __name(setEachItem, "setEachItem");
  return {
    inlineValues,
    inlineValueTypes,
    blocks
...
__name(getSelectionKey, "getSelectionKey");
...
__name(autoSeriesName, "autoSeriesName");
...
__name(getSeriesAutoName, "getSeriesAutoName");
function dataTaskCount(context) {
  return context.model.getRawData().count();
}
__name(dataTaskCount, "dataTaskCount");
function dataTaskReset(context) {
  var seriesModel = context.model;
  seriesModel.setData(seriesModel.getRawData().cloneShallow());
  return dataTaskProgress;
}
__name(dataTaskReset, "dataTaskReset");
function dataTaskProgress(param, context) {
  if (context.outputData && param.end > context.outputData.count()) {
    context.model.getRawData().cloneShallow(context.outputData);
  }
}
__name(dataTaskProgress, "dataTaskProgress");
function wrapData(data, seriesModel) {
  each(__spreadArrays(data.CHANGABLE_METHODS, data.DOWNSAMPLE_METHODS), function(methodName) {
    data.wrapMethod(methodName, curry(onDataChange, seriesModel));
  });
}
__name(wrapData, "wrapData");
...
__name(onDataChange, "onDataChange");
...
var ComponentView = function() {
  ...
  __name(ComponentView2, "ComponentView");
...
__name(createRenderPlanner, "createRenderPlanner");
...
__name(renderTaskPlan, "renderTaskPlan");
...
__name(renderTaskReset, "renderTaskReset");
...
__name(getStyleMapper, "getStyleMapper");
...
__name(getDefaultColorKey, "getDefaultColorKey");
var seriesStyleTask = {
...
var Scheduler = function() {
  ...
  Scheduler2.prototype._performStageTasks = function(stageHandlers, ecModel, payload, opt) {
    ...
    __name(needSetDirty, "needSetDirty");
...
__name(overallTaskReset, "overallTaskReset");
function stubReset(context) {
  return context.overallProgress && stubProgress;
}
__name(stubReset, "stubReset");
function stubProgress() {
  this.agent.dirty();
  this.getDownstream().dirty();
}
__name(stubProgress, "stubProgress");
function stubOnDirty() {
  this.agent && this.agent.dirty();
}
__name(stubOnDirty, "stubOnDirty");
function seriesTaskPlan(context) {
  return context.plan ? context.plan(context.model, context.ecModel, context.api, context.payload) : null;
}
__name(seriesTaskPlan, "seriesTaskPlan");
...
__name(makeSeriesTaskProgress, "makeSeriesTaskProgress");
function seriesTaskCount(context) {
  return context.data.count();
}
__name(seriesTaskCount, "seriesTaskCount");
...
__name(detectSeriseType, "detectSeriseType");
var ecModelMock = {};
var apiMock = {};
var seriesType;
...
__name(mockMethods, "mockMethods");
...
var axisCommon = /* @__PURE__ */ __name(function() {
  return {
    axisLine: {
      lineStyle: {
        color: contrastColor
...
var ECEventProcessor = function() {
  ...
  __name(ECEventProcessor2, "ECEventProcessor");
...
__name(getCandidateAnchor, "getCandidateAnchor");
...
__name(projectPointToArc, "projectPointToArc");
...
__name(projectPointToLine, "projectPointToLine");
...
__name(projectPointToRect, "projectPointToRect");
var tmpPt = [];
...
__name(nearestPointOnRect, "nearestPointOnRect");
...
__name(nearestPointOnPath, "nearestPointOnPath");
...
__name(updateLabelLinePoints, "updateLabelLinePoints");
var tmpArr = [];
...
__name(limitTurnAngle, "limitTurnAngle");
...
__name(setLabelLineState, "setLabelLineState");
...
__name(buildLabelLinePath, "buildLabelLinePath");
...
__name(setLabelLineStyle, "setLabelLineStyle");
...
__name(getLabelLineStatesModels, "getLabelLineStatesModels");
...
__name(prepareLayoutList, "prepareLayoutList");
function shiftLayout(list, xyDim, sizeDim, minBound, maxBound, balanceShift) {
  ...
  __name(updateMinMaxGap, "updateMinMaxGap");
  ...
  __name(takeBoundsGap, "takeBoundsGap");
  ...
  __name(squeezeGaps, "squeezeGaps");
  ...
  __name(squeezeWhenBailout, "squeezeWhenBailout");
  return adjusted;
}
__name(shiftLayout, "shiftLayout");
function shiftLayoutOnX(list, leftBound, rightBound, balanceShift) {
  return shiftLayout(list, "x", "width", leftBound, rightBound, balanceShift);
}
__name(shiftLayoutOnX, "shiftLayoutOnX");
function shiftLayoutOnY(list, topBound, bottomBound, balanceShift) {
  return shiftLayout(list, "y", "height", topBound, bottomBound, balanceShift);
}
__name(shiftLayoutOnY, "shiftLayoutOnY");
...
__name(hideOverlap, "hideOverlap");
...
__name(prepareLayoutCallbackParams, "prepareLayoutCallbackParams");
...
__name(extendWithKeys, "extendWithKeys");
...
var LabelManager = function() {
  ...
  __name(LabelManager2, "LabelManager");
  ...
  LabelManager2.prototype.updateLayoutConfig = function(api) {
    ...
    __name(createDragHandler, "createDragHandler");
...
__name(handleSeriesLegacySelectEvents, "handleSeriesLegacySelectEvents");
...
__name(handleLegacySelectEvents, "handleLegacySelectEvents");
...
__name(findEventDispatcher, "findEventDispatcher");
...
__name(symbolPathSetColor, "symbolPathSetColor");
...
__name(createLinearGradient, "createLinearGradient");
...
__name(createRadialGradient, "createRadialGradient");
...
__name(getCanvasGradient, "getCanvasGradient");
...
__name(isClipPathChanged, "isClipPathChanged");
...
__name(normalizeLineDash, "normalizeLineDash");
...
__name(styleHasStroke, "styleHasStroke");
function styleHasFill(style) {
  var fill = style.fill;
  return fill != null && fill !== "none";
}
__name(styleHasFill, "styleHasFill");
...
__name(doStrokePath, "doStrokePath");
...
__name(createCanvasPattern, "createCanvasPattern");
...
__name(bindCommonProps, "bindCommonProps");
...
__name(bindPathAndTextCommonStyle, "bindPathAndTextCommonStyle");
function bindImageStyle(ctx, el, prevEl, forceSetAll, scope) {
  return bindCommonProps(ctx, getStyle(el, scope.inHover), prevEl && getStyle(prevEl, scope.inHover), forceSetAll, scope);
}
__name(bindImageStyle, "bindImageStyle");
...
__name(updateClipStatus, "updateClipStatus");
...
__name(isTransformChanged, "isTransformChanged");
...
__name(canPathBatch, "canPathBatch");
...
__name(flushPathDrawn, "flushPathDrawn");
...
__name(brushSingle, "brushSingle");
...
__name(brushIncremental, "brushIncremental");
...
function createOrUpdatePatternFromDecal(decalObject, api) {
  ...
  function setPatternnSource(pattern2) {
    ...
    __name(getPatternSize, "getPatternSize");
    function brushDecal() {
      if (ctx) {
      ...
      __name(brushSymbol, "brushSymbol");
    }
    __name(brushDecal, "brushDecal");
  }
  __name(setPatternnSource, "setPatternnSource");
}
__name(createOrUpdatePatternFromDecal, "createOrUpdatePatternFromDecal");
...
__name(normalizeSymbolArray, "normalizeSymbolArray");
...
__name(normalizeDashArrayX, "normalizeDashArrayX");
...
__name(normalizeDashArrayY, "normalizeDashArrayY");
function getLineBlockLengthX(dash) {
  return map(dash, function(line2) {
    return getLineBlockLengthY(line2);
  });
}
__name(getLineBlockLengthX, "getLineBlockLengthX");
...
__name(getLineBlockLengthY, "getLineBlockLengthY");
...
__name(decalVisual, "decalVisual");
...
__name(parsePaintServerUnit, "parsePaintServerUnit");
...
__name(parseGradientColorStops, "parseGradientColorStops");
...
__name(inheritStyle, "inheritStyle");
...
__name(applyTextAlignment, "applyTextAlignment");
var urlRegex = /^url\(\s*#(.*?)\)/;
...
__name(getFillStrokeStyle, "getFillStrokeStyle");
...
__name(applyDefs, "applyDefs");
var numberReg2 = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g;
function splitNumberSequence(rawStr) {
  return rawStr.match(numberReg2) || [];
}
__name(splitNumberSequence, "splitNumberSequence");
...
__name(parseTransformAttribute, "parseTransformAttribute");
...
__name(parseInlineStyle, "parseInlineStyle");
...
__name(parseAttributeStyle, "parseAttributeStyle");
...
__name(makeViewBoxTransform, "makeViewBoxTransform");
...
__name(isAroundEqual2, "isAroundEqual");
...
var GeoJSONRegion = function(_super) {
  ...
  __name(GeoJSONRegion2, "GeoJSONRegion");
...
var GeoSVGRegion = function(_super) {
  ...
  __name(GeoSVGRegion2, "GeoSVGRegion");
...
var GeoSVGResource = function() {
  ...
  __name(GeoSVGResource2, "GeoSVGResource");
...
__name(createRegions, "createRegions");
...
__name(decodePolygon, "decodePolygon");
...
__name(parseGeoJSON, "parseGeoJSON");
...
__name(fixTextCoords, "fixTextCoords");
...
__name(fixGeoCoords, "fixGeoCoords");
...
__name(fixDiaoyuIsland, "fixDiaoyuIsland");
...
var GeoJSONResource = function() {
  ...
  __name(GeoJSONResource2, "GeoJSONResource");
...
__name(createRegisterEventWithLowercaseECharts, "createRegisterEventWithLowercaseECharts");
...
__name(createRegisterEventWithLowercaseMessageCenter, "createRegisterEventWithLowercaseMessageCenter");
function toLowercaseNameAndCallEventful(host, method, args) {
  args[0] = args[0] && args[0].toLowerCase();
  return Eventful_default.prototype[method].apply(host, args);
}
__name(toLowercaseNameAndCallEventful, "toLowercaseNameAndCallEventful");
...
var ECharts = function(_super) {
  ...
  function ECharts2(dom, theme2, opts) {
    ...
    __name(prioritySortFunc, "prioritySortFunc");
  ...
  ECharts2.prototype._initEvents = function() {
    ...
    each4(MOUSE_EVENT_NAMES, function(eveName) {
      var handler = /* @__PURE__ */ __name(function(e2) {
  ...
  ECharts2.internalField = function() {
    prepare = /* @__PURE__ */ __name(function(ecIns) {
    ...
    prepareView = /* @__PURE__ */ __name(function(ecIns, isComponent) {
    ...
    updateDirectly = /* @__PURE__ */ __name(function(ecIns, method, payload, mainType, subType) {
      var ecModel = ecIns._model;
    ...
    doConvertPixel = /* @__PURE__ */ __name(function(ecIns, methodName, finder, value) {
      if (ecIns._disposed) {
    ...
    doDispatchAction = /* @__PURE__ */ __name(function(payload, silent) {
      var _this = this;
      var ecModel = this.getModel();
      var payloadType = payload.type;
    ...
    flushPendingActions = /* @__PURE__ */ __name(function(silent) {
    ...
    triggerUpdatedEvent = /* @__PURE__ */ __name(function(silent) {
      !silent && this.trigger("updated");
    }, "triggerUpdatedEvent");
    bindRenderedEvent = /* @__PURE__ */ __name(function(zr, ecIns) {
    ...
    bindMouseEvent = /* @__PURE__ */ __name(function(zr, ecIns) {
    ...
    clearColorPalette = /* @__PURE__ */ __name(function(ecModel) {
      ecModel.clearColorPalette();
      ecModel.eachSeries(function(seriesModel) {
        seriesModel.clearColorPalette();
      });
    }, "clearColorPalette");
    render = /* @__PURE__ */ __name(function(ecIns, ecModel, api, payload) {
    ...
    renderComponents = /* @__PURE__ */ __name(function(ecIns, ecModel, api, payload, dirtyList) {
    ...
    renderSeries = /* @__PURE__ */ __name(function(ecIns, ecModel, api, payload, dirtyMap) {
      var scheduler = ecIns._scheduler;
    ...
    performPostUpdateFuncs = /* @__PURE__ */ __name(function(ecModel, api) {
      each4(postUpdateFuncs, function(func) {
        func(ecModel, api);
      });
    }, "performPostUpdateFuncs");
    markStatusToUpdate = /* @__PURE__ */ __name(function(ecIns) {
      ecIns[STATUS_NEEDS_UPDATE_KEY] = true;
      ecIns.getZr().wakeUp();
    }, "markStatusToUpdate");
    applyChangedStates = /* @__PURE__ */ __name(function(ecIns) {
    ...
    __name(applyElementStates, "applyElementStates");
    ...
    __name(updateHoverLayerStatus, "updateHoverLayerStatus");
    ;
    ...
    __name(updateBlend, "updateBlend");
    ;
    ...
    __name(updateStates, "updateStates");
    ;
    createExtensionAPI = /* @__PURE__ */ __name(function(ecIns) {
    ...
    enableConnect = /* @__PURE__ */ __name(function(chart) {
      ...
      __name(updateConnectedChartsStatus, "updateConnectedChartsStatus");
      each4(eventActionMap, function(actionType, eventType) {
    ...
    setTransitionOpt = /* @__PURE__ */ __name(function(chart, transitionOpt) {
...
__name(getInstanceByDom, "getInstanceByDom");
...
__name(registerPreprocessor, "registerPreprocessor");
...
__name(registerCoordinateSystem, "registerCoordinateSystem");
...
__name(getCoordinateSystemDimensions, "getCoordinateSystemDimensions");
function registerLayout(priority, layoutTask) {
  normalizeRegister(visualFuncs, priority, layoutTask, PRIORITY_VISUAL_LAYOUT, "layout");
}
__name(registerLayout, "registerLayout");
function registerVisual(priority, visualTask) {
  normalizeRegister(visualFuncs, priority, visualTask, PRIORITY_VISUAL_CHART, "visual");
}
__name(registerVisual, "registerVisual");
var registeredTasks = [];
...
__name(dataIndexMapValueLength, "dataIndexMapValueLength");
function defaultKeyGetter(item) {
  return item;
}
__name(defaultKeyGetter, "defaultKeyGetter");
...
__name(summarizeDimensions, "summarizeDimensions");
...
__name(getOrCreateEncodeArr, "getOrCreateEncodeArr");
function getDimensionTypeByAxis(axisType) {
  return axisType === "category" ? "ordinal" : axisType === "time" ? "time" : "float";
}
__name(getDimensionTypeByAxis, "getDimensionTypeByAxis");
function mayLabelDimType(dimType) {
  return !(dimType === "ordinal" || dimType === "time");
}
__name(mayLabelDimType, "mayLabelDimType");
...
var DataDimensionInfo = function() {
  ...
  __name(DataDimensionInfo2, "DataDimensionInfo");
...
var List = function() {
  ...
  List2.internalField = function() {
    ...
    __name(getDimValueSimply, "getDimValueSimply");
    prepareInvertedIndex = /* @__PURE__ */ __name(function(list) {
    ...
    getIdNameFromStore = /* @__PURE__ */ __name(function(list, dimIdx, ordinalMeta, rawIndex) {
      var val;
    ...
    getIndicesCtor = /* @__PURE__ */ __name(function(list) {
      return list._rawCount > 65535 ? CtorUint32Array : CtorUint16Array;
    }, "getIndicesCtor");
    prepareStorage = /* @__PURE__ */ __name(function(storage2, dimInfo, end2, append) {
    ...
    getRawIndexWithoutIndices = /* @__PURE__ */ __name(function(idx) {
      return idx;
    }, "getRawIndexWithoutIndices");
    getRawIndexWithIndices = /* @__PURE__ */ __name(function(idx) {
      if (idx < this._count && idx >= 0) {
        return this._indices[idx];
      }
      return -1;
    }, "getRawIndexWithIndices");
    getId = /* @__PURE__ */ __name(function(list, rawIndex) {
    ...
    normalizeDimensions = /* @__PURE__ */ __name(function(dimensions) {
      if (!isArray(dimensions)) {
        dimensions = dimensions != null ? [dimensions] : [];
      }
      return dimensions;
    }, "normalizeDimensions");
    validateDimensions = /* @__PURE__ */ __name(function(list, dims) {
    ...
    cloneListForMapAndSample = /* @__PURE__ */ __name(function(original, excludeDimensions) {
    ...
    __name(cloneChunk, "cloneChunk");
    getInitialExtent = /* @__PURE__ */ __name(function() {
      return [Infinity, -Infinity];
    }, "getInitialExtent");
    setItemDataAndSeriesIndex = /* @__PURE__ */ __name(function(child) {
    ...
    transferProperties = /* @__PURE__ */ __name(function(target, source) {
    ...
    makeIdFromName = /* @__PURE__ */ __name(function(list, idx) {
...
__name(completeDimensions, "completeDimensions");
...
__name(getDimCount, "getDimCount");
...
__name(createDimensions, "createDimensions");
...
__name(getCoordSysInfoBySeries, "getCoordSysInfoBySeries");
var fetchers = {
...
__name(enableDataStack, "enableDataStack");
function isDimensionStacked(data, stackedDim) {
  return !!stackedDim && stackedDim === data.getCalculationInfo("stackedDimension");
}
__name(isDimensionStacked, "isDimensionStacked");
function getStackedDimension(data, targetDim) {
  return isDimensionStacked(data, targetDim) ? data.getCalculationInfo("stackResultDimension") : targetDim;
}
__name(getStackedDimension, "getStackedDimension");
...
__name(createListFromArray, "createListFromArray");
...
__name(isNeedCompleteOrdinalData, "isNeedCompleteOrdinalData");
...
__name(firstDataNotNull, "firstDataNotNull");
...
var OrdinalMeta = function() {
  ...
  __name(OrdinalMeta2, "OrdinalMeta");
...
__name(intervalScaleNiceTicks, "intervalScaleNiceTicks");
function getIntervalPrecision(interval) {
  return getPrecision(interval) + 2;
}
__name(getIntervalPrecision, "getIntervalPrecision");
...
var OrdinalScale = function(_super) {
  ...
  __name(OrdinalScale2, "OrdinalScale");
...
var IntervalScale = function(_super) {
  ...
  __name(IntervalScale2, "IntervalScale");
...
__name(getSeriesStackId, "getSeriesStackId");
function getAxisKey(axis) {
  return axis.dim + axis.index;
}
__name(getAxisKey, "getAxisKey");
...
__name(prepareLayoutBarSeries, "prepareLayoutBarSeries");
...
__name(getValueAxesMinGaps, "getValueAxesMinGaps");
...
__name(makeColumnLayout, "makeColumnLayout");
...
__name(doCalBarWidthAndOffset, "doCalBarWidthAndOffset");
...
__name(retrieveColumnLayout, "retrieveColumnLayout");
var largeLayout = {
  seriesType: "bar",
...
__name(isOnCartesian, "isOnCartesian");
function isInLargeMode(seriesModel) {
  return seriesModel.pipelineContext && seriesModel.pipelineContext.large;
}
__name(isInLargeMode, "isInLargeMode");
function getValueAxisStart(baseAxis, valueAxis, stacked) {
  return valueAxis.toGlobalCoord(valueAxis.dataToCoord(valueAxis.type === "log" ? 1 : 0));
}
__name(getValueAxisStart, "getValueAxisStart");

// node_modules/echarts/lib/scale/Time.js
var bisect = /* @__PURE__ */ __name(function(a, x, lo, hi) {
  while (lo < hi) {
    var mid = lo + hi >>> 1;
    if (a[mid][1] < x) {
      lo = mid + 1;
...
function isUnitValueSame(unit, valueA, valueB, isUTC) {
  ...
  var isSame = /* @__PURE__ */ __name(function(unit2) {
    return getUnitValue(dateA, unit2, isUTC) === getUnitValue(dateB, unit2, isUTC);
  }, "isSame");
  var isSameYear = /* @__PURE__ */ __name(function() {
    return isSame("year");
  }, "isSameYear");
  var isSameMonth = /* @__PURE__ */ __name(function() {
    return isSameYear() && isSame("month");
  }, "isSameMonth");
  var isSameDay = /* @__PURE__ */ __name(function() {
    return isSameMonth() && isSame("day");
  }, "isSameDay");
  var isSameHour = /* @__PURE__ */ __name(function() {
    return isSameDay() && isSame("hour");
  }, "isSameHour");
  var isSameMinute = /* @__PURE__ */ __name(function() {
    return isSameHour() && isSame("minute");
  }, "isSameMinute");
  var isSameSecond = /* @__PURE__ */ __name(function() {
    return isSameMinute() && isSame("second");
  }, "isSameSecond");
  var isSameMilliSecond = /* @__PURE__ */ __name(function() {
...
__name(isUnitValueSame, "isUnitValueSame");
function getDateInterval(approxInterval, daysInMonth) {
  approxInterval /= ONE_DAY;
  return approxInterval > 16 ? 16 : approxInterval > 7.5 ? 7 : approxInterval > 3.5 ? 4 : approxInterval > 1.5 ? 2 : 1;
}
__name(getDateInterval, "getDateInterval");
function getMonthInterval(approxInterval) {
  var APPROX_ONE_MONTH = 30 * ONE_DAY;
  approxInterval /= APPROX_ONE_MONTH;
  return approxInterval > 6 ? 6 : approxInterval > 3 ? 3 : approxInterval > 2 ? 2 : 1;
}
__name(getMonthInterval, "getMonthInterval");
function getHourInterval(approxInterval) {
  approxInterval /= ONE_HOUR;
  return approxInterval > 12 ? 12 : approxInterval > 6 ? 6 : approxInterval > 3.5 ? 4 : approxInterval > 2 ? 2 : 1;
}
__name(getHourInterval, "getHourInterval");
function getMinutesAndSecondsInterval(approxInterval, isMinutes) {
  approxInterval /= isMinutes ? ONE_MINUTE : ONE_SECOND;
  return approxInterval > 30 ? 30 : approxInterval > 20 ? 20 : approxInterval > 15 ? 15 : approxInterval > 10 ? 10 : approxInterval > 5 ? 5 : approxInterval > 2 ? 2 : 1;
}
__name(getMinutesAndSecondsInterval, "getMinutesAndSecondsInterval");
function getMillisecondsInterval(approxInterval) {
  return nice(approxInterval, true);
}
__name(getMillisecondsInterval, "getMillisecondsInterval");
...
__name(getFirstTimestampOfUnit, "getFirstTimestampOfUnit");
function getIntervalTicks(bottomUnitName, approxInterval, isUTC, extent3) {
  ...
  __name(addTicksInSpan, "addTicksInSpan");
  ...
  __name(addLevelTicks, "addLevelTicks");
  var levelsTicks = [];
...
__name(getIntervalTicks, "getIntervalTicks");
...
__name(fixRoundingError, "fixRoundingError");
...
__name(ensureScaleRawExtentInfo, "ensureScaleRawExtentInfo");
function parseAxisModelMinMax(scale4, minMax) {
  return minMax == null ? null : eqNaN(minMax) ? NaN : scale4.parse(minMax);
}
__name(parseAxisModelMinMax, "parseAxisModelMinMax");
...
__name(getScaleExtent, "getScaleExtent");
...
__name(adjustScaleForOverflow, "adjustScaleForOverflow");
...
__name(niceScaleExtent, "niceScaleExtent");
...
__name(createScaleByModel, "createScaleByModel");
...
__name(makeLabelFormatter, "makeLabelFormatter");
function getAxisRawValue(axis, tick) {
  return axis.type === "category" ? axis.scale.getLabel(tick) : tick.value;
}
__name(getAxisRawValue, "getAxisRawValue");
function getOptionCategoryInterval(model) {
  var interval = model.get("interval");
  return interval == null ? "auto" : interval;
}
__name(getOptionCategoryInterval, "getOptionCategoryInterval");
function shouldShowAllLabels(axis) {
  return axis.type === "category" && getOptionCategoryInterval(axis.getLabelModel()) === 0;
}
__name(shouldShowAllLabels, "shouldShowAllLabels");

// node_modules/echarts/lib/coord/axisModelCommonMixin.js
var AxisModelCommonMixin = function() {
  function AxisModelCommonMixin2() {
  }
  __name(AxisModelCommonMixin2, "AxisModelCommonMixin");
...
__name(createAxisLabels, "createAxisLabels");
...
__name(createAxisTicks, "createAxisTicks");
...
__name(makeCategoryLabels, "makeCategoryLabels");
...
__name(makeCategoryLabelsActually, "makeCategoryLabelsActually");
...
__name(makeCategoryTicks, "makeCategoryTicks");
...
__name(makeRealNumberLabels, "makeRealNumberLabels");
function getListCache(axis, prop) {
  return inner5(axis)[prop] || (inner5(axis)[prop] = []);
}
__name(getListCache, "getListCache");
...
__name(makeAutoCategoryInterval, "makeAutoCategoryInterval");
...
__name(calculateCategoryInterval, "calculateCategoryInterval");
...
__name(fetchAutoCategoryIntervalCalculationParams, "fetchAutoCategoryIntervalCalculationParams");
...
__name(makeLabelsByNumericCategoryInterval, "makeLabelsByNumericCategoryInterval");
...
__name(makeLabelsByCustomizedCategoryInterval, "makeLabelsByCustomizedCategoryInterval");
...
__name(fixExtentWithBands, "fixExtentWithBands");
...
__name(fixOnBandTicksCoords, "fixOnBandTicksCoords");
...
var DatasetModel = function(_super) {
  ...
  __name(DatasetModel2, "DatasetModel");
...
var DatasetView = function(_super) {
  ...
  __name(DatasetView2, "DatasetView");
...
var Layer = function(_super) {
  ...
  Layer2.prototype.createRepaintRects = function(displayList, prevList, viewWidth, viewHeight) {
    ...
    __name(addRectToMergePool, "addRectToMergePool");
...
__name(isLayerValid, "isLayerValid");
...
var CanvasPainter = function() {
  ...
  CanvasPainter2.prototype._doPaintList = function(list, prevList, paintAll) {
    ...
    var _loop_1 = /* @__PURE__ */ __name(function(k2) {
      ...
      var i;
      var repaint = /* @__PURE__ */ __name(function(repaintRect) {
        var scope = {
          inHover: false,
          allClipped: false,
          prevEl: null,
  ...
  CanvasPainter2.prototype._updateLayerStatus = function(list) {
    ...
    __name(updatePrevLayer, "updatePrevLayer");
...
__name(generateNodeKey, "generateNodeKey");
var Graph = function() {
...
__name(createGraphDataProxyMixin, "createGraphDataProxyMixin");
...
__name(transferInjection, "transferInjection");
function changeInjection(opt, res) {
  opt.struct && opt.struct.update();
  return res;
}
__name(changeInjection, "changeInjection");
...
__name(getLinkedDataAll, "getLinkedDataAll");
function isMainData(data) {
  return inner6(data).mainData === data;
}
__name(isMainData, "isMainData");
...
//# sourceMappingURL=chunk-WIRZZKZ5.js.map
